                        ...
                        <div class="tab-pane fade {{ $lang->code == 'en' ? 'show active' : '' }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="page_content_{{ $lang->code }}"
                                    class="form-control summernote" rows="10">{{ old('page_content_'.$lang->code) }}</textarea>
            ...
            <div class="card border-0 shadow mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="page_slug" class="form-control" placeholder="page-url-slug" value="{{ old('page_slug') }}">
                    ...
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" name="status" id="statusSwitch" value="active" checked>
