    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.dynamic_page.update', $page->id) }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="page_content" id="description" class="form-control" rows="5">{{ old('page_content', $page->page_content) }}</textarea>
                            @error('page_content')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-check form-switch mb-4">
                            <input class="form-check-input" type="checkbox" name="set_home" id="setHomeSwitch"
                                value="1" {{ old('set_home', $page->is_home ?? 0) == 1 ? 'checked' : '' }}>
